...
using PersonAPIServerSide.Authentication;
...
namespace PersonAPIServerSide.Controllers
{
	...
	public class UserController : ControllerBase
	{
		...
		{
			jwtSecret = configuration["JwtSecret"] ?? string.Empty;
		}
		...
		[HttpGet("CheckCredentials", Name = "CheckUserCredentials")] // Marks this method to respond to HTTP GET requests.
		[ProducesResponseType(StatusCodes.Status200OK)]
		[ProducesResponseType(StatusCodes.Status401Unauthorized)]
		[ProducesResponseType(StatusCodes.Status400BadRequest)]
		public ActionResult CheckUserCredentials(Models.User user)
		{
			...
			return Ok(Authenticator.CreateToken(user.UserName, expiresAt, jwtSecret));
